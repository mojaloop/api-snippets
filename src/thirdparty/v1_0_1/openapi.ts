...
export interface components {
  ...
  schemas: {
     ...
     * This response will be given by a PATCH call on the /thirdpartytransactions/{ID} resource.
    ...
    /**
     * Used by: PISP
     * The HTTP request POST /thirdpartytransactions is used to request the creation of a transaction request on the server for the transfer described in the request.
     * Callback and data model information for POST /thirdpartytransactions:
     * Callback - PUT /thirdpartytransactions/{ID} Error Callback - PUT /thirdpartytransactions/{ID}/error Data Model - See link below
    ...
    /**
     * Used by: DFSP
     * After a PISP requests the creation of a Third Party Transaction request (POST /thirdpartytransactions) or the status of a previously created Third Party Transaction request (GET /thirdpartytransactions/{ID}), the DFSP will send this callback.
    ...
    /**
     * Used by: DFSP
     * The HTTP request POST /thirdpartyauthorizations is used to request the validation by a customer for the transfer described in the request.
     * Callback and data model information for POST /thirdpartyauthorizations:
     * Callback - PUT /thirdpartyauthorizations/{ID} Error Callback - PUT /thirdpartyauthorizations/{ID}/error Data Model - See below url
     * https://github.com/mojaloop/documentation/blob/master/website/versioned_docs/v1.0.1/api/thirdparty/data-models.md#31612-post-thirdpartyrequestsauthorizations
     */
    ...
    /**
     * The object sent in the PUT /thirdpartyauthorizations/{ID} callback.
     */
    ...
    /**
     * The object sent in the POST /thirdpartyverifications request.
     */
     ...
     * The callback PUT /thirdpartyverifications/{ID} is used to inform the client of the result of an authorization check. The {ID} in the URI should contain the authorizationRequestId which was used to request the check, or the {ID} that was used in the GET /thirdpartyverifications/{ID}.
