...
export interface components {
  schemas: {
    ...
    AuthorizationsPostRequest: {
       ...
       */
      amount: {
        currency: components["schemas"]["Account"]["properties"]["currency"];
        /**
      ...
      transactionId: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
      transactionRequestId: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
      /**
       * The object sent in the PUT /quotes/{ID} callback.
       */
      quote: {
        transferAmount: components["schemas"]["AuthorizationsPostRequest"]["properties"]["amount"];
        payeeReceiveAmount?: components["schemas"]["AuthorizationsPostRequest"]["properties"]["amount"];
        payeeFspFee?: components["schemas"]["AuthorizationsPostRequest"]["properties"]["amount"];
        payeeFspCommission?: components["schemas"]["AuthorizationsPostRequest"]["properties"]["amount"];
        expiration: components["schemas"]["ConsentsPostRequest"]["properties"]["revokedAt"];
        /**
    ...
    ConsentsIDPatchResponse: {
      ...
      revokedAt: components["schemas"]["ConsentsPostRequest"]["properties"]["revokedAt"];
    };
    /**
    ...
    ConsentsIDPutResponseSigned: {
       ...
       */
      requestId: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
      participantId: components["schemas"]["ConsentsPostRequest"]["properties"]["participantId"];
      /**
       * PISP identifier who uses this Consent.
       */
      initiatorId: components["schemas"]["ConsentsPostRequest"]["properties"]["participantId"];
      scopes: components["schemas"]["Scope"][];
    ...
    ConsentsPostRequest: {
       ...
       */
      id: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
      /**
       * The id of the ConsentRequest that was used to initiate the
       * creation of this Consent.
       */
    ...
    Party: {
      ...
      partyIdInfo: {
        ...
        fspId?: components["schemas"]["ConsentsPostRequest"]["properties"]["participantId"];
      };
      /**
    ...
    ThirdpartyRequestsTransactionsIDAuthorizationsPostRequest: {
       ...
       */
      consentId: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
      /**
    ...
    ThirdpartyRequestsTransactionsIDAuthorizationsPutResponse: {
       ...
       * Base64 encoded binary string - the signed challenge.
       */
      value: components["schemas"]["ThirdpartyRequestsTransactionsIDAuthorizationsPostRequest"]["properties"]["value"]["allOf"]["0"];
      /**
    ...
    ThirdpartyRequestsTransactionsIDPutResponse: {
       ...
       */
      transactionRequestState?: components["schemas"]["ThirdpartyRequestsTransactionsIDPatchResponse"]["properties"]["transactionRequestState"];
    };
    /**
    ...
    ThirdpartyRequestsTransactionsPostRequest: {
       ...
       */
      payee: {
        partyIdInfo: components["schemas"]["Party"]["properties"]["partyIdInfo"];
        merchantClassificationCode?: components["schemas"]["Party"]["properties"]["merchantClassificationCode"];
        name?: components["schemas"]["Party"]["properties"]["name"];
        personalInfo?: components["schemas"]["Party"]["properties"]["personalInfo"];
      };
      /**
       * Information about the Payer in the proposed financial transaction.
       */
      payer: components["schemas"]["ThirdpartyRequestsTransactionsPostRequest"]["properties"]["payee"]["allOf"]["0"];
      /**
       ...
       */
      amount: components["schemas"]["AuthorizationsPostRequest"]["properties"]["amount"];
      /**
       * Type of transaction.
       */
      transactionType: {
         ...
         */
        refundInfo?: {
          originalTransactionId: components["schemas"]["ConsentRequestsPostRequest"]["properties"]["id"];
          /**
