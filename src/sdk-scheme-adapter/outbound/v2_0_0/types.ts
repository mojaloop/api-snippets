...
export namespace Types {
  ...
  export type bulkTransferOptions = components['schemas']['bulkTransferOptions']
  ...
  export type bulkTransferContinuationAcceptParty = components['schemas']['bulkTransferContinuationAcceptParty']
  export type bulkTransferContinuationAcceptQuote = components['schemas']['bulkTransferContinuationAcceptQuote']
  export type partyError = components['schemas']['partyError']
  export type bulkAcceptPartyErrorResponse = components['schemas']['bulkAcceptPartyErrorResponse']
  export type quoteError = components['schemas']['quoteError']
  export type bulkAcceptQuoteErrorResponse = components['schemas']['bulkAcceptQuoteErrorResponse']
